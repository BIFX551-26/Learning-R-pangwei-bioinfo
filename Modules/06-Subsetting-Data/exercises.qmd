...
The first statement asks R to return the first twenty coiumns of gapminder, while the second statement asks R for the first twenty rows.
...
#solution 2:
gappminder_small <- rbind(gapminder[1:9,],
                          gapminder[19:23,])
